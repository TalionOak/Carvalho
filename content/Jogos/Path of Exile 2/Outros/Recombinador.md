...
Você junta dois itens do mesmo tipo (Varinha com outra varinha) para conseguir 2 modificador que você escolher. Ainda é possível selecionar bases diferentes, desde que compartilhem modificadores iguais entre si.

É possível também usar itens que foram <span style="color:rgb(0, 176, 240)">fraturados</span>, assim você consegue 3 modificadores em um item!

Você pode usar o ![[Presságio da Recombinação.png|20]]<span style="color:rgb(0, 176, 240)">Presságio da Recombinação</span> para aumentar sua chance de sucesso ao recombinar qualquer item.

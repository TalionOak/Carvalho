...
- 2 Orbe Exaltado Maior;
	- 7 Orbe exaltado.
- 2 Presságio da Exaltação Uniforme;
	- 248 Orbe exaltado.
- 2 Presságio da Exaltação Grandiosa;
	- 4 Orbe exaltado.
...
1. Conseguir uma base com <span style="color:rgb(255, 0, 0)"># ao Nível de todas as Gemas Habilidades de Magias</span> <span style="color:rgb(0, 176, 80)">de Caos/Raio/Gelo/Fogo/Física</span> e uma de  <span style="color:rgb(255, 0, 0)">Dano <span style="color:rgb(0, 176, 80)">de Caos/Raio/Gelo/Fogo/Físico</span> aumentado em #%</span>;
	...
	1. Recombinar as duas bases no <span style="color:rgb(0, 176, 240)">Recombinador</span>, selecionando os 2 modificadores.
		- Você pode usar um <span style="color:rgb(0, 176, 240)">Presságio da Recombinação</span> para aumentar suas chances;
